...
class nnUNetDataset(object):
    def __init__(self, folder: str, case_identifiers: List[str] = None,
        ...
        for c in case_identifiers:
            ...
            self.dataset[c]['global_info'] = join(folder, f"{c}_global.npy")
    ...
    def load_case(self, key):
        ...
        global_info = np.load(entry['global_info']) if isfile(entry['global_info']) else None
        ...
        return data, seg, entry['properties'], global_info
